...
export const dataTableBlockSchema: Template = {
	...
	fields: [
		...
		{ type: 'string', label: 'Anchor ID', name: 'anchorId', description: 'Optional HTML id on the section so jump links can target it. Enter the id only (e.g. "communities", no leading "#").' },
		{
