...
export const guideHeroBlockSchema: Template = {
	...
	fields: [
		...
		{ type: 'number', label: 'Focal X', name: 'focalX', description: 'Horizontal focal point of the mobile 5:4 photo frame, in percent (default 50).' },
		{ type: 'number', label: 'Focal Y', name: 'focalY', description: 'Vertical focal point of the mobile 5:4 photo frame, in percent (default 42).' },
